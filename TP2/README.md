...
```
C:\Windows\system32>netsh interface ip set address "Ethernet" static 10.172.89.1 255.255.252.0 10.172.91.255
```
...
```
C:\Windows\system32>ping 10.172.89.2

Envoi d’une requête 'Ping'  10.172.89.2 avec 32 octets de données :
Réponse de 10.172.89.2 : octets=32 temps=1 ms TTL=128
Réponse de 10.172.89.2 : octets=32 temps=1 ms TTL=128
Réponse de 10.172.89.2 : octets=32 temps=1 ms TTL=128
Réponse de 10.172.89.2 : octets=32 temps=1 ms TTL=128

Statistiques Ping pour 10.172.89.2:
...
Interface : 10.172.89.1 --- 0xd
  Adresse Internet      Adresse physique      Type
  10.172.89.2           60-18-95-44-10-10     dynamique
...
Envoi d’une requête 'Ping'  10.172.89.2 avec 32 octets de données :
Réponse de 10.172.89.2 : octets=32 temps=5 ms TTL=128
Réponse de 10.172.89.2 : octets=32 temps=3 ms TTL=128
Réponse de 10.172.89.2 : octets=32 temps=3 ms TTL=128
Réponse de 10.172.89.2 : octets=32 temps=3 ms TTL=128
...
- Source : b4:45:06:bf:f7:76 (Mon adresse MAC)
- Destination : ff:ff:ff:ff:ff:ff  (Adresse MAC Broadcast)

Deuxième trame :

- Source : 60:18:95:44:10:10 (Adresse MAC de mon binôme)
- Destination : b4:45:06:bf:f7:76 (Mon adresse MAC)
...
- Source : 7c:21:4a:e4:8a:27
- Destination : ff:ff:ff:ff:ff:ff

Trame Offer :

- Source : 00:c0:e7:e0:04:4e
- Destination : 7c:21:4a:e4:8a:27
